...
<template>
    <div v-show="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="bg-white lg:w-2/3 w-full mx-auto overflow-auto">
    ...
    <div v-show="data.type === 'decile'" class="bg-white lg:w-2/3 w-full mx-auto overflow-auto">
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
            <tr>
    ...
    <div v-show="data.type === 'rfm'" class="bg-white lg:w-2/3 w-full mx-auto overflow-auto">
        合計 {{ data.totals }} 人
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
            <tr>
