                                        ...
                                        <div class="p-2 w-full">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.kana"  class="mt-2"/>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.tel"  class="mt-2"/>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.postcode"  class="mt-2"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div>
                                                        <label for="gender_1" class="ml-2 mr-1">男性</label><input type="radio" id="gender_1" name="gender" v-model="form.gender" value="0" />
                                                        <label for="gender_2" class="ml-2 mr-1">女性</label><input type="radio" id="gender_2" name="gender" v-model="form.gender" value="1" />
                                                        <label for="gender_3" class="ml-2 mr-1">不明</label><input type="radio" id="gender_3" name="gender" v-model="form.gender" value="2" />
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.memo" class="mt-2" />
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
