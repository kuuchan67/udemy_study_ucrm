                                ...
                                <div class="p-2 w-full">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <div>
                                                <label for="is_saling" class="ml2 mr-4">販売中</label><input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="1" />

                                                <label for="is_saling" class="ml2 mr-4">停止中</label><input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="0" />

                                            <InputError :message="errors.is_selling" class="mt-2" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-2 w-full">
                                        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">商品追加</button>
                                    </div>
                                </div>
                            </div>
                        </div>
